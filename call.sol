...
contract Receiver {
    ...
    receive() external payable {
        emit Received(msg.sender, msg.value, "Fallback wall called");
    }
...
contract Caller {
    ...
    // Let's imagine that contract B does not have the source code for contract A, but we do know the address of A and the function to call.
